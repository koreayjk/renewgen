...
function PurposeStaircase() {
  const steps = [
    { n: 1, t: "리뉴젠 강화 원격 네트워크", d: "아카데미와 지역 공동체의 네트워크를 강화해 대한민국에 기독교 교육이 더 굳건히 자리 잡도록 합니다." },
    { n: 2, t: "리뉴젠 기독교 교재 개발", d: "일반 학문을 기독교적 관점으로 투영한 한국형 기독교 교과 교재, 나아가 교과서를 개발합니다." },
    { n: 3, t: "대한민국 기독교 네트워크 확장", d: "교회학교·대안학교·홈스쿨 등 여러 모양의 기독교 교육을 수호하는 팀·개인에게 콘텐츠를 제공하며 연합합니다." },
    { n: 4, t: "교육을 통한 전도", d: "탁월한 강의와 탄탄한 교재로, 수업과 교육이 복음 전도의 통로가 되도록 합니다." },
  ];
  return (
